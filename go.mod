...
require (
	...
	github.com/olicesx/quic-go v0.0.0-20260828011724-ffb802f42fbf
...
replace github.com/olicesx/quic-go => github.com/olicesx/quic-go v0.0.0-20260828011724-ffb802f42fbf
