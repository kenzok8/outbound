...
require (
	...
	github.com/olicesx/quic-go v0.0.0-20260813123212-4e322a72fd98
...
replace github.com/olicesx/quic-go => github.com/olicesx/quic-go v0.0.0-20260813123212-4e322a72fd98
