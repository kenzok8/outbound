...
// Handles Min >= Max defensively (returns Min to avoid rand.Intn(0) panic).
...
// paddings (authRequest goes up to 2048 bytes). Bias from %62 on a 256-value
// space is negligible — this padding is for traffic-shape obfuscation, not
// crypto.
